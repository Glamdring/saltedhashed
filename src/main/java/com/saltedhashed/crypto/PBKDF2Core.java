...
public abstract class PBKDF2Core extends SecretKeyFactorySpi {
     ...
     */
    @Override
    protected KeySpec engineGetKeySpec(SecretKey key, @SuppressWarnings("rawtypes") Class keySpecCl)
        ...
        if (key instanceof javax.crypto.interfaces.PBEKey) {
            ...
            if ((keySpecCl != null) && PBEKeySpec.class.isAssignableFrom(keySpecCl)) {
                ...
                return new PBEKeySpec(pKey.getPassword(), pKey.getSalt(), pKey.getIterationCount(),
    ...
    protected SecretKey engineTranslateKey(SecretKey key) throws InvalidKeyException {
        if ((key != null) && (key.getAlgorithm().equalsIgnoreCase("PBKDF2With" + prfAlgo))
            ...
            if (key instanceof javax.crypto.interfaces.PBEKey) {
                javax.crypto.interfaces.PBEKey pKey = (javax.crypto.interfaces.PBEKey) key;
                try {
                    PBEKeySpec spec = new PBEKeySpec(pKey.getPassword(), pKey.getSalt(),
